				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control datepicker" name="event_start_date" value="<?php echo date('d-m-Y'); ?>">(Formato: dd-mm-aa)
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Data final do Evento <span>*</span></label>
							<div class="col-sm-2">
								<input type="text" class="form-control datepicker" name="event_end_date" value="<?php echo date('d-m-Y'); ?>">(Format: dd-mm-aa)
							</div>
						</div>
						<div class="form-group">
