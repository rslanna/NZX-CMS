...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/event/add" class="btn btn-primary btn-sm">Adicionar Novo</a>
	</div>
</section>
							...
							foreach ($event as $row) {
								...
								<tr>
									...
									<td>										
										...
										<a href="<?php echo base_url(); ?>admin/event/delete/<?php echo $row['event_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Excluir</a>  
									</td>
								</tr>
								<?php
							}
