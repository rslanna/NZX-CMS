...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Jul-2019 às 10:53
...
(1, 'slider-1.jpg', 'AQUI VOCÊ PODE COLOCAR UM SLOGAN LEGAL', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit.', 'Read More', '#', 'Entre em contato', '#', 'Left'),
(2, 'slider-2.jpg', 'AQUI VAI O SEGUNDO SLOGAN MAIS LEGAL AINDA', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit.', 'Read More', '#', 'Entre em contato', '#', 'Right');
